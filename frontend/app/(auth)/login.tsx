        ...
        <View className="flex-1 px-8">
          ...
          <View className="mb-6">
            ...
            <View className="relative flex-row items-center border-b border-black">
              ...
              <View className="absolute right-0 p-2">
                <MaterialCommunityIcons name="eye" size={20} color="#a3a3a3" />
              </View>
            </View>
          </View>
          ...
          <View className="pt-10">
            ...
            <View className="flex items-center pt-8">
              <Text className="text-sm font-light opacity-40 text-black ">
                Don't have an account?
              </Text>
              <TouchableOpacity>
                <Text className="text-sm font-medium text-black  border-b border-black b-0.5 tracking-wide">
                  Sign Up
                </Text>
              </TouchableOpacity>
            </View>
